...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const layoutLists = () => {
			...
			this.container.classList.add('nebulaLogo');

			const logoContainer = $('.nebula-hero-logo', {},
				$('img.nebula-logo-image', { src: FileAccess.asBrowserUri('vs/workbench/contrib/welcomeGettingStarted/browser/media/nebula_logo.png').toString(true) })
			);
			reset(rightColumn, logoContainer);
