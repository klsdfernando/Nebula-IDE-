...
export class ChatStatusBarEntry extends Disposable implements IWorkbenchContribution {
	...
	private getEntryProps(): IStatusbarEntry {
		let text = '$(sparkle) Nebula IDE';
		let ariaLabel = localize('chatStatusAria', "Nebula IDE status");
		...
		if (isNewUser(this.chatEntitlementService)) {
			...
			// Signed out
				...
				text = `${this.chatEntitlementService.anonymous ? '$(sparkle)' : '$(debug-disconnect)'} Nebula IDE`;
